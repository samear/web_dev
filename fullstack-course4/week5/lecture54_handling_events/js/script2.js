// document.addEventListener let you assign the evnets to the elements of the
// page once they load. And since we are going to be listening the that event,
// we no longer need to provide this script at the bottom of the page.
document.addEventListener("DOMContentLoaded",
    function(event) {
        ...
        // we remove onclick="sayHello()" from <button> element (button>say it!</button>) from index2.html
